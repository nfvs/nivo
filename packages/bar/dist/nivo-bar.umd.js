(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-motion', '@nivo/core', '@nivo/axes', '@nivo/legends', 'lodash/min', 'lodash/max', 'lodash/range', 'd3-scale', 'lodash/flattenDepth', 'd3-shape', 'lodash/uniqBy', 'recompose/setDisplayName', 'recompose', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'recompose/pure', '@nivo/colors', 'prop-types', 'recompose/compose', '@nivo/tooltip', '@nivo/annotations'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.ReactMotion, global.nivo, global.nivo, global.nivo, global['lodash/min'], global['lodash/max'], global['lodash/range'], global.d3, global['lodash/flattenDepth'], global.d3, global['lodash/uniqBy'], global.RecomposeSetDisplayName, global.Recompose, global.RecomposeDefaultProps, global.RecomposeWithPropsOnChange, global.RecomposePure, global.nivo, global.PropTypes, global.RecomposeCompose, global.nivo, global.nivo));
}(this, (function (exports, React, reactMotion, core, axes, legends, min, max, range, d3Scale, flattenDepth, d3Shape, _uniqBy, setDisplayName, recompose, defaultProps, withPropsOnChange, pure, colors, PropTypes, compose, tooltip, annotations) { 'use strict';
    ...
    var getGroupedScale = function getGroupedScale(data, keys, _minValue, _maxValue, range, round) {
      ...
      return d3Scale.scaleLinear().call(round ? 'rangeRound' : 'round')(range).domain([minValue, maxValue]);
    };
    ...
    var generateHorizontalGroupedBars = function generateHorizontalGroupedBars(_ref2) {
      var data = _ref2.data,
          ...
          _ref2$roundRange = _ref2.roundRange,
          roundRange = _ref2$roundRange === void 0 ? true : _ref2$roundRange;
      var xRange = reverse ? [width, 0] : [0, width];
      var xScale = getGroupedScale(data, keys, minValue, maxValue, xRange, roundRange);
